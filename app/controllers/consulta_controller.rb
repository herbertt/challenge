class ConsultaController < ApplicationController
  ...
  # GET /consulta/1.json
  def show
    number_total = (@consultum.vencimento.to_f / 10).ceil
	@taxa =  (number_total * 1.65).round(2)
	@total_descontado = (@taxa * @consultum.val_titulo.to_f/100).round(2)	
	@total_cliente = @consultum.val_titulo.to_f - @total_recebido.to_f
  end
  ...
  private
    ...
    def consultum_params
      params.require(:consultum).permit(:user_name, :email, :empresa, :faturamento, :val_titulo, :vencimento)
    end
end
